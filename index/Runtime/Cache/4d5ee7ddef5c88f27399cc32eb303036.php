...
__URL__/doadmin/letter_to/网站管理员" method="post" onsubmit="return frmnewmessage_validate();">
    <table width="100%" class="grid" cellspacing="1" align="center">
      ...
      <tr valign="middle" align="left">
        ...
        <td class="even"><input type="text" class="text" name="title" id="title" size="30" maxlength="100" value="" />
        </td>
      </tr>
      <tr valign="middle" align="left">
      ...
      <tr valign="middle" align="left">
        ...
        <td class="even"><input type="submit" class="button" name="submit" id="submit" value="发 送" /><input
            type="hidden" name="action" id="action" value="newmessage" /></td>
      </tr>
    </table>
  </form>
