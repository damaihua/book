    ...
    <div class="wrap clearfix mb20">
                    ...
                    <div class="c_right">
                        ...
                        <div class="sum hidden clearfix">
                            ...
                            <div>
                                <?php echo ($book_info[0]['book_info']); ?>
                            </div>
                        </div>
                            ...
                            <div class="cmt_list">
                                <ul>
                                    <?php if(is_array($comment)): foreach($comment as $key=>$vo): ?><li>
                                            ...
                                            <p class="info">
                                                <span>发表人<strong><?php echo ($vo["user_name"]); ?></strong></span>
                                ...
                                <table cellspacing="0" cellpadding="0">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="text" style="width:590px;" name="ptitle"
                                                    id="ptitle" maxlength="60" value="" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="t1">
                                                <label>评论内容：</label></td>
                                            <td>
                                                <textarea class="iptxt" style="width:595px;height:150px;"
                                                    name="pcontent" id="pcontent"></textarea>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <input type="hidden" name="book_id"
                                                value="<?php echo ($book_info[0]['book_id']); ?>" />
                                            <td>
