...
<!--行2-->
	<div class="row clearfix">
    	<div class="column row_bg comments " style="width:717px;height:312px;">
            <div class="title_pic">最新免费小说</div>
            <ul class="list_02 list_vip">
	...
	<?php if(is_array($newfree)): $i = 0; $__LIST__ = $newfree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/bookInfo/index/book_id/<?php echo ($vo["book_id"]); ?>" target="_blank">111<img src="__ROOT__/<?php echo ($vo["book_cover"]); ?>" /></a><h3><a href="__APP__/bookInfo/index/book_id/<?php echo ($vo["book_id"]); ?>" target="_blank">《<?php echo ($vo["book_name"]); ?>》</a></h3><p><?php echo (substr($vo["book_info"],0,66)); ?></p></li><?php endforeach; endif; else: echo "" ;endif; ?>	
        ...
        <div class="column" style="height:312px;">
                <h2><span class="rank">免费小说点击榜</span></h2>
...
<!--行3-->
	<div class="row clearfix">
    	<div class="column_leftwrap">
            <div class="column" style="height:312px;">
                <h2><span>免费小说随机推荐</span></h2>
                <ul class="tab_cnt2">
<?php if(is_array($rand)): $i = 0; $__LIST__ = $rand;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/bookInfo/index/book_id/<?php echo ($vo["book_id"]); ?>" target="_blank"><?php echo ($vo["book_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>

              </ul>
            </div>
         </div>
        <div class="column column_update" style="height:312px;">
        	<h2><span class="update">最新更新</span></h2>
           
            <ul class="tab_cnt1" style=" margin-top:5px;margin-bottom:5px;">
<?php if(is_array($newfree)): $i = 0; $__LIST__ = $newfree;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><span><?php echo (date("Y_m-d ",$vo["update_time"])); ?> </span><em>[玄幻]</em><a href="__APP__/bookInfo/index/book_id/<?php echo ($vo["book_id"]); ?>" target="_blank">《<?php echo ($vo["book_name"]); ?>》</a></li><?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="column_rightwrap">
        	<div class="column" style="height:312px;">
                <h2><span>免费小说字数榜</span></h2>
                <ul class="tab_cnt2">

<?php if(is_array($size)): $i = 0; $__LIST__ = $size;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="__APP__/bookInfo/index/book_id/<?php echo ($vo["book_id"]); ?>" target="_blank"><?php echo ($vo["book_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
