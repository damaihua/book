...
<div class="wrap">
    <div class="clearfix wrap mb20">
        <div class="recommend-banner">
            <h2 class="common-headline"><span>最新免费小说</span></h2>
            <ul>
        ...
        <div class="common-right most-popular">
            <h2 class="common-headline"><span>免费小说点击榜</span></h2>
            <ul>
	...
	<div class="clearfix mb20">
        <div class="new-arrival common-left">
			<h2 class="common-headline"><span>免费小说随机推荐</span></h2>
			<ul class="new-books">
        ...
        <div class="new-arrival common-right">
			<h2 class="common-headline"><span>免费小说字数榜</span></h2>
			<ul class="new-books">
