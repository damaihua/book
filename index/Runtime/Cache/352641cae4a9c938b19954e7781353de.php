...
<li><a  href="__APP__/member/applyauthor">申请作者</a></li>
  ...
  <tr>
    <td class="even"><form name="frmalipay" method="post" action="__APP__/member/repay">
      <table cellpadding="0" cellspacing="0" border="0" width="100%">
        <tbody><tr>
          <td width="4%">&nbsp;</td>
          <td valign="middle" width="44%"><table cellpadding="3" cellspacing="0" border="0" width="262">
              <tbody><tr>
                <td align="left">请选择购买类别</td>
              </tr>
              <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td><input name="paycard" value="<?php echo ($vo["paycard_id"]); ?>" class="radio" type="radio">
            <?php echo ($vo["paycard_score"]); ?>积分卡（<?php echo ($vo["paycard_money"]); ?>元）</td>
          ...
          <td valign="top" width="48%"><p>操作说明：<br>
            <br>
