...
<table cellpadding="3" cellspacing="1" align="center" bgcolor="#D6D6D6" border="0" width="98%">
  <tbody>
		...
		<form action="__APP__/other/do_notice_edit" method="post" >
  		...
  		<tr>
  		  <td colspan="2" valign="top"><textarea name="content"  style="width:100%;height:400px;">1111<?php echo ($data["content"]); ?></textarea>  
          <span class="Validform_checktip">内容不少于10个汉字！</span>        
          </td>
         </tr>
  		<tr>
        <td><input type="submit" value="修改公告"> 
		</td>
        <td></td>
        </tr>	
