	...
	<div id="main-content">
		<div class="content-box">
			<div class="content-box-header">
				<h3 style="cursor: s-resize;">&nbsp;<a href="cat_main"><u>菜单管理</u></a>&gt;&gt;&nbsp;增加菜单</h3>
			</div> 

			<div class="content-box-content">
				<form action="__URL__/do_menu_add" method="post">
						...
						<fieldset>
							...
							<p>
								...
								<input name="name" type="text" class="text-input small-input" id="name"
									style="width:60px" size="30"> (不必再写首页和论坛菜单)
							</p>
							<p>
								<label>链接地址</label>
								<input name="url" type="text" class="text-input small-input" id="url=" value="/"" size="
									30"width:60px> (不包括域名，如/bbs/)
							</p>
							<p>
								<label>显示位置</label>
								<input name="position" value='header' checked type="radio">
								头部
								<input name="position" value='footer' type="radio">
								底部
							</p>
							<p>
								<label>排列顺序</label>
								<input name="ordernum" size="6" value="10" class="text-input small-input"
