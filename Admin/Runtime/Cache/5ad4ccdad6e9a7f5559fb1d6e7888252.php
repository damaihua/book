					...
					<table cellpadding="3" cellspacing="1" align="center" bgcolor="#FBFCE2" border="0" width="98%">
						<form action="__URL__/do_ad_edit" method="post" enctype="multipart/form-data">
							<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr>
								...
								<tr>
									<td>广告位图片</td>
									<td><input type="text" value="<?php echo ($vo["image"]); ?>"><input name='image' type="file" /></td>
								</tr><br />
								<tr>
									<td>链接地址</td>
									<td><input type="text" name="url" value="<?php echo ($vo["url"]); ?>" datatype="url"
											nullmsg="请填写正确的url！" errormsg="请填写正确的url！"><span
											class="Validform_checktip"></span></td>
								</tr>

								<tr><br /><?php endforeach; endif; ?>
							<tr>
								<td><input type="submit" name="submit" value="修改"> <input type="hidden" name="id"
