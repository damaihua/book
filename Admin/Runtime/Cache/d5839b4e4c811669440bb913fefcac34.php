          ...
          <table cellpadding="0" cellspacing="1" align="center" border="1" width="100%">
            <tbody>
              ...
              <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr align="center" height="26">
                  <td>
                    <?php echo ($vo["paycard_id"]); ?>
                  </td>

                  <td>
                    <?php echo ($vo["paycard_score"]); ?>
                  </td>

                  <td>
                    <?php echo ($vo["paycard_money"]); ?> RMB
                  </td>
                  <td align="center">
                    <a href="http://localhost/dede/dede/member_view.php?id=1">修改</a> |
                    <a href="__APP__/score/paycard_del?id=<?php echo ($vo["paycard_id"]); ?>" onclick="return confirm('确定要删除?')">删除</a>
                  </td>
