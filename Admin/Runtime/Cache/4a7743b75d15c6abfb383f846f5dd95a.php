...
<tr class="alt-row" align="center" bgcolor="#FBFCE2" height="26">
          ...
          <td width="21%">管理</td>
        	...
        	<?php if(is_array($data)): foreach($data as $key=>$vo): ?><tr onmousemove="javascript:this.bgColor='#FCFDEE';" onmouseout="javascript:this.bgColor='#FFFFFF';" align="center" bgcolor="#FFFFFF" height="26">
          ...
          <td><?php if($vo["status"] == 1 ): ?>已审核通过
<?php else: ?> <font color="#FF0000">未审核通过</font><?php endif; ?></td>
          <td>
