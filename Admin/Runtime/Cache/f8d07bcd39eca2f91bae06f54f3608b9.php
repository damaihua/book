    ...
    //             });        
			...
			<div  class="content-box">
				...
				<div  class="content-box-header">
					...
					<h3  style="cursor: s-resize;">修改章节</h3>
				...
				<div  class="content-box-content">
					...
					<form name="form" action="__URL__/do_chapter_edit" enctype="multipart/form-data" method="post" onsubmit="return checkSubmit()" >
						...
						<fieldset> 
							<p>
								<label>小说标题</label>
								<input name="book_name"  type="text" value="<?php echo ($chapter['book_name']); ?>" disabled> 
							</p>
							<p>
                                <label>章节名</label>   
                                <!-- <?php echo getData('Book',$book_id,'book_name');?> -->
								<input name="chapter_title" type="text" value="<?php echo getData('Chapter',$chapter_id,'chapter_title');?>"> 
							</p>
							...
							<p>
								<label>所需积分</label>
								<input name="chapter_much"  type="text" value="<?php echo getData('Chapter',$chapter_id,'much');?>"> 
							</p>
							<p>
								<label>内容</label>
