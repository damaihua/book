                    ...
                    <table cellpadding="1" cellspacing="1" border="0" width="98%">
                      <tbody>
                        <tr>
                          ...
                          <td style="text-align:left;" width="84%"><input name="paycard_score" id="paycard_score"
                              size="16" style="width:200px" type="text"></td>
                        </tr>
                        <tr>
                          <td height="30">所需金钱：</td>
                          <td style="text-align:left;"><input name="paycard_money" id="paycard_money" size="16"
