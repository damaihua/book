...
<div id="main-content">
  ...
  <p>
									<label>菜单名称</label>
			    <input name="name" type="text" class="text-input small-input" id="name"  style="width:60px" size="30"> (不必再写首页和论坛菜单)
			  </p>
              <p>
									<label>链接地址</label>
			    <input name="url" type="text" class="text-input small-input" id="url=" value="/"" size="30"width:60px> (不包括域名，如/bbs/)
			  </p>
              <p>
									<label>显示位置</label>
