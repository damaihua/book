	  ...
	  $(".nav-bottom-item[href='"+curhref+"']",window.parent.menu.document).parent().parent().show(); // Slide down the clicked sub menu
			...
			<div  class="content-box">
				...
				<div  class="content-box-header">
					...
					<h3  style="cursor: s-resize;">小说章节列表</h3>
							...
							<tbody>
								...
								<?php if(is_array($chapter)): foreach($chapter as $key=>$vo): ?><tr>
											...
											<td class="odd" align="center">
												<a href="__APP__/book/book_list/book_id/<?php echo ($vo["book_id"]); ?>"><?php echo ($vo["chapter_title"]); ?>
											</td>
											<td class="odd" align="center">
												<a href=""><?php echo ($vo["book_name"]); ?>
											</td>
											<td class="odd" align="center"><?php echo (date("Y-m-d H:i",$vo["update_time"])); ?></td>
											<td class="odd" align="center">
												<a href="__URL__/delChap/chapter_id/<?php echo ($vo["chapter_id"]); ?>">删除</a>
											</td>
